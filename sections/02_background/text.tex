    ...
    \subsection{Imaging Domains and Scanner Properties} %1.5 pages
        ...
        \begin{figure}
            \begin{minipage}{\textwidth}
                ...
                \caption{Top: One \ac{CT} and several \ac{MRI} images of different datasets. Bottom: Histogram of the image intensities each scaled to min-max feature scales. The \ac{CT} historgram is shaded with the corresponding image grayscale intensities. Appearance of \ac{CT} and \ac{MRI} images differ substantially but also \ac{MRI} images have a large variation in appearance due to different scanners and acquisition protocols.}
