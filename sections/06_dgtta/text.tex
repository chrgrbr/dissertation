...
\label{sec:introduction_dgtta}
    ...
    Supervised finetuning can be used as a workaround to retrain or finetune networks for the unseen domain. Still, it would, in turn, require curating and labelling data again, which is costly and time-consuming. The most frequently studied approach to overcome this effort is using unsupervised domain adaptation (UDA), which incorporates labeled source and unlabeled target data \citep{guan2021domain,zhu2017unpaired,zhu2017unpaired,park2020contrastive,choi2021using,chen2020unsupervised,varsavsky2020test}.
...
\subsection{Contribution}
    ...
    \begin{itemize}
        ...
        \item We perform TTA with a lean self-supervision scheme previously seen in UDA/SFDA \citep{varsavsky2020test,perone2019unsupervised}
    ...
    \subsection{Related work}
        ...
        % and similarly in \citep{chen2020unsupervised} where CT and MRI domains were bridged.
        ...
        Adversely, in \citep{varsavsky2020test},
...
\section{Methods}
    ...
    We propose using \emph{MIND} descriptors \citep{heinrich2013towards}
    ...
    \subsection{Optimization strategy}
        ...
        All models were optimized with the \emph{AdamW} optimizer with a learning rate of  $\eta=1e{-5}$, weight decay $\beta=0.01$, and no scheduling for twelve epochs.
...
\section{Experiments and Results}
    ...
    \subsection{Experiment structure}
        \subsubsection{Experiment I: Domain gap evaluation of non-DG and DG pre-trained models}
            ...
            % \citep{ioffe2015batch,ulyanov2016instance}.
            Five models were pre-trained with domain generalization techniques targeting the input data augmentation: A nnUNet model with extensive spatial and intensity augmentation (INSANE DA), checkerboard masked images with a dropout rate of 30\% (MIC, \citep{hoyer2023mic}),
